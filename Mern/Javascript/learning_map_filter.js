...
const newmap = products.mapping((products)=> ({name: products.name,price: products.price}));

console.log(newmap);

newmap.filtering = function(callback){
    const ans = [];
...
const newobj = newmap.filtering((newmap)=>newmap.price > 50);
